        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            ...
            <div className="flex w-full justify-between lg:w-auto">
              ...
              >
                <Menu className="data-[state=active]:opacity-0 m-auto size-6 duration-200" data-state={!menuState} />
                <X className="absolute inset-0 m-auto size-6 opacity-0 rotate-180 scale-0 duration-200 data-[state=active]:opacity-100 data-[state=active]:rotate-0 data-[state=active]:scale-100" data-state={menuState} />
              </button>
            </div>
